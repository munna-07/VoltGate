...
func (e schedulerProviderTestExecutor) Execute(ctx context.Context, auth *Auth, req voltgateexecutor.Request, opts voltgateexecutor.Options) (voltgateexecutor.Response, error) {
	return voltgateexecutor.Response{}, nil
}

func (e schedulerProviderTestExecutor) ExecuteStream(ctx context.Context, auth *Auth, req voltgateexecutor.Request, opts voltgateexecutor.Options) (*voltgateexecutor.StreamResult, error) {
	return nil, nil
}
...
func (e schedulerProviderTestExecutor) CountTokens(ctx context.Context, auth *Auth, req voltgateexecutor.Request, opts voltgateexecutor.Options) (voltgateexecutor.Response, error) {
	return voltgateexecutor.Response{}, nil
}
...
func TestManager_RefreshSchedulerEntry_RebuildsSupportedModelSetAfterModelRegistration(t *testing.T) {
	...
	for _, testCase := range testCases {
		...
		t.Run(testCase.name, func(t *testing.T) {
			...
			got, errPick := manager.scheduler.pickSingle(ctx, "gemini", "scheduler-refresh-model", voltgateexecutor.Options{}, nil)
			var authErr *Error
...
func TestManager_PickNext_RebuildsSchedulerAfterModelCooldownError(t *testing.T) {
	...
	got, errPick := manager.scheduler.pickSingle(ctx, "gemini", "scheduler-cooldown-rebuild-model", voltgateexecutor.Options{}, nil)
	...
	got, executor, errPick := manager.pickNext(ctx, "gemini", "scheduler-cooldown-rebuild-model", voltgateexecutor.Options{}, nil)
	if errPick != nil {
