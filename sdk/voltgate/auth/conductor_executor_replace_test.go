...
func (e *replaceAwareExecutor) Execute(context.Context, *Auth, voltgateexecutor.Request, voltgateexecutor.Options) (voltgateexecutor.Response, error) {
	return voltgateexecutor.Response{}, nil
}

func (e *replaceAwareExecutor) ExecuteStream(context.Context, *Auth, voltgateexecutor.Request, voltgateexecutor.Options) (*voltgateexecutor.StreamResult, error) {
	ch := make(chan voltgateexecutor.StreamChunk)
	close(ch)
	return &voltgateexecutor.StreamResult{Chunks: ch}, nil
}
...
func (e *replaceAwareExecutor) CountTokens(context.Context, *Auth, voltgateexecutor.Request, voltgateexecutor.Options) (voltgateexecutor.Response, error) {
	return voltgateexecutor.Response{}, nil
}
