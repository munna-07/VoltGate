...
func (e schedulerBenchmarkExecutor) Execute(ctx context.Context, auth *Auth, req voltgateexecutor.Request, opts voltgateexecutor.Options) (voltgateexecutor.Response, error) {
	return voltgateexecutor.Response{}, nil
}

func (e schedulerBenchmarkExecutor) ExecuteStream(ctx context.Context, auth *Auth, req voltgateexecutor.Request, opts voltgateexecutor.Options) (*voltgateexecutor.StreamResult, error) {
	return nil, nil
}
...
func (e schedulerBenchmarkExecutor) CountTokens(ctx context.Context, auth *Auth, req voltgateexecutor.Request, opts voltgateexecutor.Options) (voltgateexecutor.Response, error) {
	return voltgateexecutor.Response{}, nil
}
