...
func newUsageReporter(ctx context.Context, provider, model string, auth *voltgateauth.Auth) *usageReporter {
...
func resolveUsageSource(auth *voltgateauth.Auth, ctxAPIKey string) string {
	if auth != nil {
