...
import (
	...
	iflowauth "github.com/voltgate/voltgate/v6/internal/auth/iflow"
...
func (e *IFlowExecutor) PrepareRequest(req *http.Request, auth *voltgateauth.Auth) error {
	if req == nil {
		return nil
	}
...
func (e *IFlowExecutor) HttpRequest(ctx context.Context, auth *voltgateauth.Auth, req *http.Request) (*http.Response, error) {
	if req == nil {
...
func (e *IFlowExecutor) Execute(ctx context.Context, auth *voltgateauth.Auth, req voltgateexecutor.Request, opts voltgateexecutor.Options) (resp voltgateexecutor.Response, err error) {
...
func (e *IFlowExecutor) ExecuteStream(ctx context.Context, auth *voltgateauth.Auth, req voltgateexecutor.Request, opts voltgateexecutor.Options) (_ *voltgateexecutor.StreamResult, err error) {
	if opts.Alt == "responses/compact" {
...
func (e *IFlowExecutor) CountTokens(ctx context.Context, auth *voltgateauth.Auth, req voltgateexecutor.Request, opts voltgateexecutor.Options) (voltgateexecutor.Response, error) {
	baseModel := thinking.ParseSuffix(req.Model).ModelName
	...
	if err != nil {
		return voltgateexecutor.Response{}, fmt.Errorf("iflow executor: tokenizer init failed: %w", err)
	}

	count, err := countOpenAIChatTokens(enc, body)
	if err != nil {
		return voltgateexecutor.Response{}, fmt.Errorf("iflow executor: token counting failed: %w", err)
	}
...
func (e *IFlowExecutor) Refresh(ctx context.Context, auth *voltgateauth.Auth) (*voltgateauth.Auth, error) {
...
func (e *IFlowExecutor) refreshCookieBased(ctx context.Context, auth *voltgateauth.Auth, cookie, email string) (*voltgateauth.Auth, error) {
...
func (e *IFlowExecutor) refreshOAuthBased(ctx context.Context, auth *voltgateauth.Auth) (*voltgateauth.Auth, error) {
	refreshToken := ""
	oldAccessToken := ""
	if auth.Metadata != nil {
...
func iflowCreds(a *voltgateauth.Auth) (apiKey, baseURL string) {
	if a == nil {
		return "", ""
	}
	if a.Attributes != nil {
