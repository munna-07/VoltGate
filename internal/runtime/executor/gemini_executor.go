...
func (e *GeminiExecutor) PrepareRequest(req *http.Request, auth *voltgateauth.Auth) error {
	if req == nil {
		return nil
	}
...
func (e *GeminiExecutor) HttpRequest(ctx context.Context, auth *voltgateauth.Auth, req *http.Request) (*http.Response, error) {
	if req == nil {
...
//
// Returns:
//   - voltgateexecutor.Response: The response from the API
//   - error: An error if the request fails
func (e *GeminiExecutor) Execute(ctx context.Context, auth *voltgateauth.Auth, req voltgateexecutor.Request, opts voltgateexecutor.Options) (resp voltgateexecutor.Response, err error) {
...
func (e *GeminiExecutor) ExecuteStream(ctx context.Context, auth *voltgateauth.Auth, req voltgateexecutor.Request, opts voltgateexecutor.Options) (_ *voltgateexecutor.StreamResult, err error) {
	if opts.Alt == "responses/compact" {
...
func (e *GeminiExecutor) CountTokens(ctx context.Context, auth *voltgateauth.Auth, req voltgateexecutor.Request, opts voltgateexecutor.Options) (voltgateexecutor.Response, error) {
	baseModel := thinking.ParseSuffix(req.Model).ModelName
	...
	if resp.StatusCode < 200 || resp.StatusCode >= 300 {
		...
		return voltgateexecutor.Response{}, statusErr{code: resp.StatusCode, msg: string(data)}
	}
...
func (e *GeminiExecutor) Refresh(_ context.Context, auth *voltgateauth.Auth) (*voltgateauth.Auth, error) {
	return auth, nil
}

func geminiCreds(a *voltgateauth.Auth) (apiKey, bearer string) {
	if a == nil {
		return "", ""
	}
	if a.Attributes != nil {
...
func resolveGeminiBaseURL(auth *voltgateauth.Auth) string {
	base := glEndpoint
...
func (e *GeminiExecutor) resolveGeminiConfig(auth *voltgateauth.Auth) *config.GeminiKey {
...
func applyGeminiHeaders(req *http.Request, auth *voltgateauth.Auth) {
