...
import (
	...
	kimiauth "github.com/voltgate/voltgate/v6/internal/auth/kimi"
...
func (e *KimiExecutor) PrepareRequest(req *http.Request, auth *voltgateauth.Auth) error {
	if req == nil {
		return nil
	}
...
func (e *KimiExecutor) HttpRequest(ctx context.Context, auth *voltgateauth.Auth, req *http.Request) (*http.Response, error) {
	if req == nil {
...
func (e *KimiExecutor) Execute(ctx context.Context, auth *voltgateauth.Auth, req voltgateexecutor.Request, opts voltgateexecutor.Options) (resp voltgateexecutor.Response, err error) {
...
func (e *KimiExecutor) ExecuteStream(ctx context.Context, auth *voltgateauth.Auth, req voltgateexecutor.Request, opts voltgateexecutor.Options) (_ *voltgateexecutor.StreamResult, err error) {
	from := opts.SourceFormat
	if from.String() == "claude" {
		auth.Attributes["base_url"] = kimiauth.KimiAPIBaseURL
	...
	go func() {
		...
		for i := range doneChunks {
			out <- voltgateexecutor.StreamChunk{Payload: []byte(doneChunks[i])}
		}
...
func (e *KimiExecutor) CountTokens(ctx context.Context, auth *voltgateauth.Auth, req voltgateexecutor.Request, opts voltgateexecutor.Options) (voltgateexecutor.Response, error) {
	auth.Attributes["base_url"] = kimiauth.KimiAPIBaseURL
...
func (e *KimiExecutor) Refresh(ctx context.Context, auth *voltgateauth.Auth) (*voltgateauth.Auth, error) {
...
func resolveKimiDeviceIDFromAuth(auth *voltgateauth.Auth) string {
...
func resolveKimiDeviceIDFromStorage(auth *voltgateauth.Auth) string {
	if auth == nil {
		return ""
	}
...
func resolveKimiDeviceID(auth *voltgateauth.Auth) string {
...
func applyKimiHeadersWithAuth(r *http.Request, token string, stream bool, auth *voltgateauth.Auth) {
...
func kimiCreds(a *voltgateauth.Auth) (token string) {
	if a == nil {
		return ""
	}
