// Package cmd provides command-line interface functionality for the VoltGate server.
...
import (
	...
	"github.com/voltgate/voltgate/v6/internal/auth/gemini"
...
func updateAuthRecord(record *voltgateauth.Auth, storage *gemini.GeminiTokenStorage) {
