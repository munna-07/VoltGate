...
// It defines common interface types used throughout the VoltGate for request and response
// transformation operations, maintaining compatibility with the SDK translator package.
package interfaces

import sdktranslator "github.com/voltgate/voltgate/v6/sdk/translator"
