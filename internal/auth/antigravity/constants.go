...
func MissingCredentialsError() error {
	return fmt.Errorf("antigravity OAuth credentials are not configured; set VOLTGATE_ANTIGRAVITY_OAUTH_CLIENT_ID and VOLTGATE_ANTIGRAVITY_OAUTH_CLIENT_SECRET")
}
