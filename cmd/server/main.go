// Package main provides the entry point for the VoltGate server.
...
import (
	...
	configaccess "github.com/voltgate/voltgate/v6/internal/access/config_access"
	"github.com/voltgate/voltgate/v6/internal/buildinfo"
	"github.com/voltgate/voltgate/v6/internal/cmd"
	...
	"github.com/voltgate/voltgate/v6/internal/store"
	_ "github.com/voltgate/voltgate/v6/internal/translator"
	"github.com/voltgate/voltgate/v6/internal/tui"
...
func main() {
	fmt.Printf("VoltGate Version: %s, Commit: %s, BuiltAt: %s\n", buildinfo.Version, buildinfo.Commit, buildinfo.BuildDate)
	...
	log.Infof("VoltGate Version: %s, Commit: %s, BuiltAt: %s", buildinfo.Version, buildinfo.Commit, buildinfo.BuildDate)
